...
export class Triangle implements Figure {
    ...
    draw() {
        if (this.p1.x instanceof Number && this.p1.y instanceof Number && 
        this.p2.x instanceof Number && this.p2.y instanceof Number &&
        this.p3.x instanceof Number && this.p3.y instanceof Number) {
